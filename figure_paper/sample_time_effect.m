...
set(p1(1),'DisplayName','{h=0.05}','LineWidth',LW, 'Color',c1);
set(p1(2),'DisplayName','{h=0.1}','LineWidth',LW, 'Color',c2);
set(p1(3),'DisplayName','{h=0.15}','LineWidth',LW, 'Color',c3);
...
set(p2(1),'DisplayName','{h=0.05}','LineWidth',LW, 'Color',c1);
set(p2(2),'DisplayName','{h=0.1}','LineWidth',LW, 'Color',c2);
set(p2(3),'DisplayName','{h=0.15}','LineWidth',LW, 'Color',c3);
g = get(p2,'Parent');
set(g{1},'Linewidth',lw,'FontSize',FS,'FontName','Times New Roman','FontWeight','bold');
